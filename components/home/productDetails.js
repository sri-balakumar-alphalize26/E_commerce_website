...
export function getDetails(p) {
  ...
  return {
    ...
    description: p.description ||
      `${p.name} from ${p.brand || p.unit} is chosen for everyday quality and value. ` +
      (kind === "care"
      ...
      "Product images are for illustration; actual packaging may vary slightly. Please check the details on the product itself before use.",
    disclaimer: "While we work to ensure product information is correct, specifications and packaging may be changed by the manufacturer. Always check the details on the product itself.",
