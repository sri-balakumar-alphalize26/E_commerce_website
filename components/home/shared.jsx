...
const P = {
  ...
  wifi: <><path d="M2 8.5a16 16 0 0 1 20 0" /><path d="M5.5 12a11 11 0 0 1 13 0" /><path d="M9 15.5a6 6 0 0 1 6 0" /><circle cx="12" cy="19" r=".8" /></>,
  laptop: <><path d="M5 5h14v10H5z" /><path d="M2 19h20l-1.5-4h-17z" /></>,
