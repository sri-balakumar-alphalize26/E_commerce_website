/** @odoo-module ignore */
/* 369mart: this file is VENDORED from 369mart_motion.zip and carries one
   local edit, marked "369mart: LOCAL EDIT" in onClick(). Re-apply it when
   dropping in a new version. */
/* ==========================================================================
  ...
  function onClick(ev) {
    ...
    if (add) {
      ...
      /* 369mart: LOCAL EDIT -- re-apply after every drop of this file.
         Buttons carrying data-mm-fly opt out of the engine's dot flight
         because lib/fly-to-cart.ts flies the product image instead. The
         sold-out shake and the pressed flash above are untouched. */
      if (!add.hasAttribute("data-mm-fly")) flyToCart(add);
      return;
    }
