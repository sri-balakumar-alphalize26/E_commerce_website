...
class LoyaltyHistory(models.Model):
    ...
    # The Point of Sale order link (`order_id`) went with Point of Sale in
    # 19.0.2.0.0. A module that sells links its own orders - 369 Mart's
    # mart369_loyalty adds `sale_order_id`.
