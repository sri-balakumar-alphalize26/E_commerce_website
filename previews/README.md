...
Standalone single-file pages — double-click to open in any browser, no install needed.
They run the same components as the app with sample data and inline sample images.
